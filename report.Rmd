...
infos_comp_bloco4 <- data.frame(
  ...
  data.frame(
    "indicador" = c(
      ...
      "Porcentagem de partos ocorridos na microrregião de saúde, mas fora do município de residência",
      "Porcentagem de partos ocorridos na macrorregião de saúde, mas fora da microrregião de saúde de residência",
      "Porcentagem de partos ocorridos na UF, mas fora da macrorregião de saúde de residência",
