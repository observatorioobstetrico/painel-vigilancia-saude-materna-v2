...
mod_nivel_3_server <- function(id, filtros, titulo_localidade_aux){
  moduleServer( id, function(input, output, session){
    ...
    indicadores_uma_caixinha_adicional_bloco7 <- c(
      ...
      "Taxa de mortalidade neonatal precoce (0 a 6 dias) por 1000 nascidos vivos  ",
      "Taxa de mortalidade neonatal tardia (7 a 27 dias) por 1000 nascidos vivos  ",
      "Porcentagem de óbitos fetais intermediários e tardios por grupos de causas evitáveis",
      "Porcentagem de óbitos perinatais tardios por grupos de causas evitáveis",
      "Porcentagem de óbitos neonatais por grupos de causas evitáveis",
      "Porcentagem de óbitos fetais intermediários e tardios por grupos de causas",
      "Porcentagem de óbitos perinatais tardios por grupos de causas",
    ...
    indicadores_duas_caixinhas_adicionais_bloco7 <- c(
      "Número de óbitos fetais intermediários e tardios (feto com idade gestacional maior ou igual a 22 semanas ou peso maior ou igual a 500g)",
      "Número de óbitos fetais fetais (feto com idade gestacional maior ou igual a 28 semanas ou peso maior ou igual a 1000g)",
    ...
    observe(print(infos_indicador()$calculo))
    observe(print(anos_disponiveis()))
