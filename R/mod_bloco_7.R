              ...
              column(
                ...
                bs4Dash::bs4Card(
                  ...
                  fluidRow(
                    column(
                      width = 12,
                      strong(p("Selecione as idades gestacionais:", style = "margin-bottom: 0.5rem")),
                      tags$div(
                        align = 'left',
                        class = 'multicol',
                        checkboxGroupInput(
...
mod_bloco_7_server <- function(id, filtros){
  moduleServer( id, function(input, output, session){
    ...
    data7_juncao_aux <-  reactive({dplyr::full_join(data7_dist(), data7_referencia_dist(), by = "ano")})
    ...
    output$plot5_neonat <- highcharter::renderHighchart({
      highcharter::highchart()|>
        highcharter::hc_add_series(
          name = "Faltante",
          data =  data7_juncao_aux_invertido(),
