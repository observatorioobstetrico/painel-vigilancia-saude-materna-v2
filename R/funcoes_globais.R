  ...
  if (indicador == "fetal peso por idade gestacional") {
    ...
    bs4Dash::box(
      ...
      div(
        ...
        div(
          p(style = style_texto, HTML(glue::glue("<b> {glue::glue(texto1)} </b>"))),
          p(style = style_descricao, "óbito antes do parto")
        ),
        div(
          p(style = style_texto, HTML(glue::glue("<b> {glue::glue(texto2)} </b>"))),
          p(style = style_descricao, "óbito durante o parto")
        )
      )
    )
    ...
    bs4Dash::box(
      ...
      div(
        ...
        div(
          p(style = style_texto, HTML(glue::glue("<b> {glue::glue(texto3)} </b>"))),
          p(style = style_descricao, "óbito no dia 0 de vida")
        ),
        div(
          p(style = style_texto, HTML(glue::glue("<b> {glue::glue(texto4)} </b>"))),
          p(style = style_descricao, "óbito de 1 a 6 dias de vida")
        )
      )
    )
    ...
    bs4Dash::box(
      ...
      div(
        ...
        div(
          p(style = style_texto, HTML(glue::glue("<b> {glue::glue(texto3)} </b>"))),
          p(style = style_descricao, "óbito de 7 a 27 dias de vida")
        )
      )
    )
