...
mod_bloco_7_neonatal_server <- function(id, filtros){
  moduleServer(id, function(input, output, session){
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Número de óbitos neonatais". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Taxa de mortalidade neonatal por 1000 nascidos vivos". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Taxa de mortalidade neonatal com idade 0 a 6 dias por 1000 nascidos vivos". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Taxa de mortalidade neonatal com idade 7 a 27 dias por 1000 nascidos vivos". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Distribuição percentual das faixas de peso por momento do óbito neonatal". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Distribuição percentual do momento do óbito neonatal por faixa de peso". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Distribuição percentual dos óbitos neonatais segundo análise de evitabilidade". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
    ...
    bs4Dash::addTooltip(
      ...
      options = list(
        title = '<span class = "fonte-media">Esta caixinha depende das escolhas feitas no gráfico "Distribuição percentual dos óbitos neonatais por grupos de causas". </span>',
        placement = "top",
        animation = TRUE,
        html = TRUE,
        delay = list(show = 75, hide = 75) # delay em ms
