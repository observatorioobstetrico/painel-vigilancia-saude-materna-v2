...
# Erro: números de colunas dos argumentos não correspondem 87 x 86

# padronizando:
#sim_mat2023 <- sim_mat2023 |> clean_names()

# Obs: as variáveis estão diferentes entre os bancos:

#> setdiff(names(df_sim_domat_aux1), names(sim_mat2023))
#[1] "estabdescr" "nudiasobin" "nudiasinf"  "fontesinf"
#> setdiff(names(sim_mat2023), names(df_sim_domat_aux1))
#[1] "opor_do"   "tp_altera" "cb_alt"
